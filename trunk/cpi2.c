/* cpi2.c - C version of the Fortran90 code calculating the value of Pi in parallel written in the USC parallel programming camp.
 * Author: Huioon Kim, pcandme@gist.ac.kr
 * Last modified by Huioon Kim, 2011.8.4
 */
